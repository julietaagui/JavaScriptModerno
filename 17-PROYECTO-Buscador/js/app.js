...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //llena las opciones de años y las carga al select
    llenarSelect();
})
...
function filtrarAuto() {
    const resultado = autos.filter( filtrarMarca).filter( filtrarYear ).filter( filtrarMinimo ).filter( filtrarMaximo ).filter( filtarPuertas ).filter
